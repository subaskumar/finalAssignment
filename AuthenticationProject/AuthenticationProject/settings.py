...
SECRET_KEY = 'django-insecure-+c)q9md0)#w1796s)8ilw2&4_&z+ms84z)axt(ey)cahjv($b4'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'ROUTING': 'AuthenticationProject.routing.channel_routing',
    }
}
